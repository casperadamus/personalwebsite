...
function About() {
  return (
    <div className="container">
      ...
      <p>
        I'm Casper Adamus — a Computer Engineering & Applied Mathematics student.
        I've had the opportunity to be a part of many influential projects and experiences.
      </p>
      ...
      <div className="section">
        ...
        <div className="timeline-item">
          ...
          <h3>Software Developer · i3</h3>
          <p>
            Volunteered with my school district to get schools tech-wise ready for the year.
          </p>
        </div>
        <div className="timeline-item">
          <span className="date">2024</span>
          ...
          <p>
            Helped improve how new aerospace clients were onboarded by using SQL to look through fleet data and build dashboard metrics. Made things easier for new hires by working with Power BI developers.
          </p>
        </div>
        <div className="timeline-item">
